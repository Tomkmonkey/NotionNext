...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'TJ博客', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'ciallo', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://nnxt.867831.xyz/', // 网站地址
